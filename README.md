...
class KaranSinghRathore:
    def __init__(self):
        ...
        self.currently_building = "VocalizeAI 🎙️"
        self.motto = "If it can be voiced, it can be automated."

    def say_hi(self):
        print("Hey! I'm Karan — I build things that talk back. 🗣️")
...
<!-- Footer Wave -->
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:6c3ce9,50:1a1b27,100:0d1117&height=120&section=footer" width="100%" />
